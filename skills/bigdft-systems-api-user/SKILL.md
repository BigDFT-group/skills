---
name: bigdft-systems-api-user
description: Use this skill when the user wants to build, manipulate, read, write, or analyze atomic structures with PyBigDFT Atom, Fragment, and System classes. Do not use it for BigDFT source maintenance, pseudopotential setup, or logfile parsing.
...
Source file: skills/systems/SKILL.md
