...
description: Use this skill when the user wants to write, modify, debug, or review BigDFT/Futile Fortran code using dictionaries, memory tracking, YAML I/O, error handling, timing, or MPI wrappers. Do not use it for simple Futile API usage tutorials, BigDFT input preparation, or CI-only log triage.
...
Source file: skills/futile/SKILL.md
