...
description: Use this skill when the user wants to call the PSolver API, understand public interfaces, prepare input data, or integrate PSolver as a library. Do not use it for source maintenance, CI debugging, internal refactoring, or performance-kernel optimization.
...
# Skill: PSolver API User

## Purpose

This role-specific skill guides an AI agent when working with **PSolver** in the context of **API usage**.

## Scope

This skill is for:

- call the PSolver API, understand public interfaces, prepare input data, or integrate PSolver as a library;
...
- source maintenance, CI debugging, internal refactoring, or performance-kernel optimization.

## Minimal Project Context

TODO: Add a concise description of PSolver that is sufficient for this skill to be useful when copied alone.
