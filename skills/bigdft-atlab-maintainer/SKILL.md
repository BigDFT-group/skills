---
name: bigdft-atlab-maintainer
description: Use this skill when the user wants to maintain or debug BigDFT ATlab code involving simulation domains, grid cells, box iterators, multipoles, spherical harmonics, numerical utilities, or field I/O. Do not use it for user-level input preparation, logfile analysis, or unrelated BigDFT components.
...
Source file: skills/atlab/SKILL.md
