---
name: psolver-maintainer
description: Use this skill when the user wants to modify, debug, refactor, test, or maintain PSolver source code. Do not use it for simple API usage, user-level tutorials, or CI-only log triage.
...
# Skill: PSolver Maintainer

## Purpose

This role-specific skill guides an AI agent when working with **PSolver** in the context of **source maintenance**.

## Scope

This skill is for:

- modify, debug, refactor, test, or maintain PSolver source code;
...
- simple API usage, user-level tutorials, or CI-only log triage.
