...
description: Use this skill when the user wants to maintain, debug, or understand PSolver internals for electrostatics, Hartree potentials, FFT-based kernels, boundary conditions, implicit solvation, or GPU acceleration. Do not use it for simple PSolver API usage or CI-only log triage.
...
Source file: skills/psolver/SKILL.md
