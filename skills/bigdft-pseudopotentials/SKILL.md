...
description: Use this skill when the user wants to select, configure, or troubleshoot pseudopotentials for BigDFT calculations, including PSP formats, PyBigDFT pseudopotential APIs, command-line PSP files, and electron-count implications. Do not use it for implementing nonlocal projector kernels or general input generation.
...
Source file: skills/pseudopotentials/SKILL.md
