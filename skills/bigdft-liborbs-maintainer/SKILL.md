---
name: bigdft-liborbs-maintainer
description: Use this skill when the user wants to maintain or debug BigDFT liborbs code involving orbitals, localization regions, wavelet compression, operator application, views, MPI distribution, or GPU paths. Do not use it for user-level input files, logfile analysis, or unrelated libraries.
...
Source file: skills/liborbs/SKILL.md
...
# Skill: Bigdft Liborbs Maintainer
