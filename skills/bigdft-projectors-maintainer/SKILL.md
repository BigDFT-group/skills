---
name: bigdft-projectors-maintainer
description: Use this skill when the user wants to implement, debug, or review BigDFT nonlocal pseudopotential projector code, including Kleinman-Bylander projectors, HGH/HGH-K radial functions, psppar layout, h_ij coupling matrices, and nonlocal matrix elements. Do not use it for routine pseudopotential selection in input files.
...
Source file: skills/projectors/SKILL.md
...
# Skill: Bigdft Projectors Maintainer
