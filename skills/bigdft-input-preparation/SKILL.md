---
name: bigdft-input-preparation
description: Use this skill when the user wants to prepare BigDFT input files in YAML or Python, choose calculation settings, define systems, or configure DFT parameters. Do not use it for modifying BigDFT source code, parsing output logs, or maintaining input-variable schemas.
...
Source file: skills/input/SKILL.md
...
# Skill: Bigdft Input Preparation
