---
name: bigdft-input-variable-maintainer
description: Use this skill when the user wants to add, modify, review, or debug input-variable definitions in BigDFT, CheSS, or PSolver, from YAML schema through generated strings, Fortran dictionaries, derived types, and runtime access. Do not use it for ordinary user input-file preparation.
...
Source file: skills/variables/SKILL.md
...
# Skill: Bigdft Input Variable Maintainer
