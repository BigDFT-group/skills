...
description: Use this skill when the user wants to design, validate, or run BigDFT workflows, including dry runs and agentic workflow preparation. Do not use it for low-level source refactoring of individual BigDFT libraries unless another skill covers that role.
...
This role-specific skill guides an AI agent when working with **BigDFT** in the context of **workflow design and execution**.

## Scope

This skill is for:

- design, validate, or run BigDFT workflows, including dry runs and agentic workflow preparation;
...
- low-level source refactoring of individual BigDFT libraries unless another skill covers that role.

## Minimal Project Context

TODO: Add a concise description of BigDFT that is sufficient for this skill to be useful when copied alone.
