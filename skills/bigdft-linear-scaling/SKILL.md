...
description: Use this skill when the user wants to configure, explain, or extend BigDFT linear-scaling calculations, including lin_basis_params, ig_occupation, support functions, rloc, nbasis, and pseudopotential electron counts. Do not use it for cubic-scaling workflows or unrelated source maintenance.
...
Source file: skills/linear-scaling/SKILL.md
