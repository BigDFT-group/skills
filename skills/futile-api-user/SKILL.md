---
name: futile-api-user
description: Use this skill when the user wants to call the Futile API, understand public interfaces, or integrate Futile utilities as a library. Do not use it for source maintenance, CI debugging, or internal refactoring.
...
# Skill: Futile API User

## Purpose

This role-specific skill guides an AI agent when working with **Futile** in the context of **API usage**.

## Scope

This skill is for:

- call the Futile API, understand public interfaces, or integrate Futile utilities as a library;
...
- source maintenance, CI debugging, or internal refactoring.
